...
1. Open **File** > **Office Account** > **About Outlook** to confirm you're running a Microsoft 365 *Current Channel* build of Outlook. Open **File** > **Account** > **Update Channel** to confirm you're running a Microsoft 365 *Current Channel* build of Word, Excel, and PowerPoint.
...
Optionally, you can use [Visual Studio Code](https://code.visualstudio.com/) to extend Teams apps into Microsoft 365, Outlook, Word, Excel and PowerPoint.
